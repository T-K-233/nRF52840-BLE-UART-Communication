...
void loop() {
  ...
  rath::PMSA003I::DataFrame psma_data = psma.get();

  ble_uart.print("\"/pm1_0\": ");
  Serial.print("\"/pm1_0\": ");
  ble_uart.print(psma_data.std_pm_1_0);
  Serial.print(psma_data.std_pm_1_0);
  ble_uart.print(", ");
  Serial.print(", ");
  
  ble_uart.print("\"/pm2_5\": ");
  Serial.print("\"/pm2_5\": ");
  ble_uart.print(psma_data.std_pm_2_5);
  Serial.print(psma_data.std_pm_2_5);
  ble_uart.print(", ");
  Serial.print(", ");
  
  ble_uart.print("\"/pm10\": ");
  Serial.print("\"/pm10\": ");
  ble_uart.print(psma_data.std_pm_10);
  Serial.print(psma_data.std_pm_10);
  ble_uart.print(", ");
  Serial.print(", ");
  
  ble_uart.print("\"/particles_0_3_um\": ");
  Serial.print("\"/particles_0_3_um\": ");
  ble_uart.print(psma_data.num_particles_0_3_um);
  Serial.print(psma_data.num_particles_0_3_um);
  ble_uart.print(", ");
  Serial.print(", ");
  
  ble_uart.print("\"/particles_1_um\": ");
  Serial.print("\"/particles_1_um\": ");
  ble_uart.print(psma_data.num_particles_1_um);
  Serial.print(psma_data.num_particles_1_um);
  ble_uart.print(", ");
  Serial.print(", ");
  
  ble_uart.print("\"/particles_10_um\": ");
  Serial.print("\"/particles_10_um\": ");
  ble_uart.print(psma_data.num_particles_10_um);
  Serial.print(psma_data.num_particles_10_um);
  ble_uart.print(", ");
  Serial.print(", ");
